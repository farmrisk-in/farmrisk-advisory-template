...
const sampleData: AdvisoryReportData = {
  header: {
    farmName: "Farm",
    locationStr: "Dehradun, Gujarat — 248001",
  ...
  whatToDoToday: [
    {
      ...
      description:
        "Improve drainage to prevent waterlogging and reduce fungal disease risk (e.g. Alternaria) at flowering.",
    },
    {
      icon: "irrigation",
      title: "Skip irrigation this week",
      description:
        "Soil is Moderate Wet and appears saturated — no irrigation needed for 7+ days. Focus on drainage.",
    },
    {
      icon: "scout",
  ...
  farmRisk: {
    overallLevel: "MEDIUM",
    contextText:
      "Warm temperatures and wet soil during Kharif raise the risk of sucking pests and fungal disease in cotton. At flowering/reproductive stage these conditions favour pest build-up, threatening boll retention and crop health.",
    actions: [
      {
        icon: "drainage",
        title: "Ensure field drainage",
        description:
          "Prevent waterlogging and reduce fungal disease (Alternaria) risk.",
      },
      {
        icon: "scout",
        title: "Monitor sucking pests",
        description:
          "Inspect for aphids, jassids & whiteflies before threshold levels.",
      },
      {
        icon: "remove",
        title: "Remove infected plants",
        description:
          "Rogue out infected plants to stop fungal disease spreading.",
      },
    ],
    irrigationNote:
      "Irrigation not needed for 7+ days. Soil looks Moderate Wet and saturated — focus on drainage.",
    soilTransition: {
      fromState: "Moderate Wet",
      toState: "Abnormally Wet",
      trendSummary:
        "Soil moisture climbs steadily over the 16 days, crossing into Abnormally Wet after the 4 Sep rain. Watch root health; drainage is the priority.",
    },
  },
  forecast16Day: [
  ...
  forecastSummaryFooter:
    "Blue-tinted days = rain expected. Total: 23.4 mm over 3 days; main fall ~13.5 mm on 4 Sep.",
};
